...
:WAIT_FOR_CODE_SERVER
    ...
    ssh -o BatchMode=yes -o ConnectTimeout=10 ctrlx-sdk-vm "test -n $(if [ -d /home/boschrexroth/.vscode-server/bin ]; then find /home/boschrexroth/.vscode-server/bin -path '*/bin/code-server' -type f -perm -111 -print -quit; fi)" >nul 2>&1
